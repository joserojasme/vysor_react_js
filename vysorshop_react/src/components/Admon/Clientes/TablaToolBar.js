...
import CamposClientes from './Crear';
import ActualizarCliente from './Actualizar';
import {connect} from 'react-redux';
import { SetModalAddCamposClientes, SetModalAddFiltroClientes } from '../../../reducers/actions/clientesActions';
...
class TablaToolbar extends Component {
    ...
    handleClickAdd = () =>{
        this.props.setModalAddCamposClientes(true);
    }
    render() {
