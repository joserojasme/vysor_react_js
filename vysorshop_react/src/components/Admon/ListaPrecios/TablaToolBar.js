...
import AgregarProductosListaPrecios from './AgregarProductosListaPrecios';
import {connect} from 'react-redux';
import { SetModalAddCamposListaPrecios } from '../../../reducers/actions/listaPreciosActions';
...
class TablaToolbar extends Component {
    ...
    handleClickAdd = () =>{
        this.props.setModalAddCamposListaPrecios(true);
    }
    render() {
        const { numSelected, classes,openModalAgregarProductosListaPrecios } = this.props;
        return (
            <Fragment>
            <Toolbar
            ...
            <Crear />
            <Actualizar/>
            {openModalAgregarProductosListaPrecios &&
                <AgregarProductosListaPrecios/>
            }
            </Fragment>
        )
    }
...
function mapStateToProps(state, props) {
    return {
        openModalAgregarProductosListaPrecios: state.listaPreciosStore.openModalAgregarProductosListaPrecios,
    }
}
